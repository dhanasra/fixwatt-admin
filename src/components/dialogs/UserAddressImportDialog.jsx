...
const UserAddressImportDialog =({open, onCancel})=>{
    ...
    const pickFile = ()=>{
      document.getElementById(`import-customer-address`).click();
    }
    ...
    const importData=async()=>{
      ...
      setLoading(false);
      setData(null);
      document.getElementById(`import-customer-address`).value = null;
      showSnackbar("User addresses imported successfully", { variant: 'success' });
    }
    ...
    const downloadSampleFormat = () => {
        ...
        XLSX.utils.book_append_sheet(wb, ws, "SampleCustomerAddress");

        XLSX.writeFile(wb, "sample_customer_addresses.xlsx");
    };
    ...
    <Dialog open={open}>
        ...
        >
            <Stack spacing={3} px={4} alignItems={"center"}>
                ...
                <input id={`import-customer-address`} type="file" accept=".xlsx, .xls" onChange={handleFileChange} style={{ display: "none" }} />
...
export default UserAddressImportDialog;